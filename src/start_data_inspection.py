...
if __name__ == '__main__':
    ...
    copy_outliers(SENTINEL_DIR, ENMAP_DIR, sentinel_outlier_dir, sentinel_figures_dir)
    ...
    plot_size_histogram(sentinel_size_df, sentinel_figures_dir, quant=0.05)
    ...
    plot_size_histogram(enmap_size_df, enmap_figures_dir, quant=0.04)
